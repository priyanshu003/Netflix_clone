...
class FeedAdapterthree(private val listener: OnMovieItemClickListener) : RecyclerView.Adapter<FeedAdapterthree.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeedAdapterthree.ViewHolder {
